...
var LayoutManager = Widget.inherit({
  ...
  _renderFieldItem: function _renderFieldItem(item, $container) {
    ...
    if (helpText && isSimpleItem) {
      var $editorParent = $editor.parent(); // TODO: DOM hierarchy is changed here: new node is added between $editor and $editor.parent()
  ...
  _renderLabel: function _renderLabel(labelOptions) {
    return renderLabel(this._getRenderLabelOptions(labelOptions));
  },
  _getRenderLabelOptions: function _getRenderLabelOptions() {
    var labelOptions = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
