...
export default class ScrollView extends ScrollViewWrapper {
  ...
  scrollToElementTopLeft(element) {
    ...
    var params = [this._patchElementParam(element)];
    return (_this$viewRef7 = this.viewRef) === null || _this$viewRef7 === void 0 ? void 0 : _this$viewRef7.scrollToElementTopLeft(...params.slice(0, arguments.length));
  }
  ...
  isFull() {
    ...
    return (_this$viewRef16 = this.viewRef) === null || _this$viewRef16 === void 0 ? void 0 : _this$viewRef16.isFull(...arguments);
  }
