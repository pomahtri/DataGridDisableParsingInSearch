...
var ScrollView = /*#__PURE__*/function (_ScrollViewWrapper) {
  ...
  _proto.scrollToElementTopLeft = function scrollToElementTopLeft(element) {
    ...
    var params = [this._patchElementParam(element)];
    return (_this$viewRef7 = this.viewRef) === null || _this$viewRef7 === void 0 ? void 0 : _this$viewRef7.scrollToElementTopLeft.apply(_this$viewRef7, _toConsumableArray(params.slice(0, arguments.length)));
  };
  ...
  _proto.isFull = function isFull() {
    ...
    return (_this$viewRef16 = this.viewRef) === null || _this$viewRef16 === void 0 ? void 0 : _this$viewRef16.isFull.apply(_this$viewRef16, arguments);
  };
