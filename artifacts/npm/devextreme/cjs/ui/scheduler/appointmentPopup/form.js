...
var getAllDayEndDate = function getAllDayEndDate(startDate) {
...
var AppointmentForm = /*#__PURE__*/function () {
  ...
  _proto.create = function create(dataExprs, triggerResize, changeSize, appointmentData, allowTimeZoneEditing, formData) {
  ...
  _proto.setEditorsType = function setEditorsType(startDateExpr, endDateExpr, allDay) {
  ...
  _proto.updateFormData = function updateFormData(formData, dataExprs) {
    this.semaphore.take();
  ...
  _createClass(AppointmentForm, [{
    ...
    set: function set(value) {
      ...
      var recurrenceRuleExpr = this.scheduler.getDataAccessors().expr.recurrenceRuleExpr; // TODO hack fore rec editor
