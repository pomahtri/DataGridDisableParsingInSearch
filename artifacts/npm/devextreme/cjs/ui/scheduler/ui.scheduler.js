...
var Scheduler = /*#__PURE__*/function (_Widget) {
  ...
  _proto._getAppointmentSettingsGenerator = function _getAppointmentSettingsGenerator(rawAppointment) {
  ...
  _proto._initMarkupCore = function _initMarkupCore(resources) {
    ...
    this._waitAsyncTemplate(function () {
      ...
      return (_this9$_workSpaceReca = _this9._workSpaceRecalculation) === null || _this9$_workSpaceReca === void 0 ? void 0 : _this9$_workSpaceReca.resolve();
    });
  ...
  _proto._appointmentsConfig = function _appointmentsConfig() {
    ...
    var config = {
      ...
      onContentReady: function onContentReady() {
        ...
        (_this11$_workSpace = _this11._workSpace) === null || _this11$_workSpace === void 0 ? void 0 : _this11$_workSpace.option('allDayExpanded', _this11._isAllDayExpanded(filteredItems));
      }
    };
    return config;
  };
  ...
  _proto.showAppointmentPopup = function showAppointmentPopup(rawAppointment, createNewAppointment, rawTargetedAppointment) {
    ...
    if (isCreateAppointment) {
      ...
      this._checkRecurringAppointment(rawAppointment, newTargetedAppointment, appointment.startDate, function () {
        _this20._editAppointmentData = rawAppointment; // TODO
